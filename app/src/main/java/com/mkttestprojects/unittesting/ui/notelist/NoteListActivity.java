...
import com.mkttestprojects.unittesting.R;
...
import com.mkttestprojects.unittesting.util.VerticalSpacingItemDecorator;
        ...
        View.OnClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewModel = ViewModelProviders.of(this, providerFactory).get(NoteListViewModel.class);
